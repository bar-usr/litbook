...
const CardListElement = ({image, title, description}: {image: string, description: string, title: string}) => {
  return (
    <div className="border border-zinc-700 bg-zinc-900/30 inset-shadow-sm p-4 rounded-md flex flex-row items-center gap-5">
...
const Card = ({ title, description, elements }: { 
  ...
  return (
    <div className="border border-zinc-700 bg-zinc-950/20 pt-4 pb-7 px-5 rounded-md flex flex-col gap-2 items-center w-[450px] shadow-lg shadow-zinc-600/10 hover:shadow-xl transition-all duration-300 backdrop-blur-sm">
...
const Header = () => {
  ...
  return (
    <div className="mt-60 mb-10 flex flex-col p-10 justify-between items-center">
      <Image src="/litbook_logo_white.png" alt="Litbook" width={400} height={400} />
      <h2 className="text-2xl mb-15 text-gray-500">
